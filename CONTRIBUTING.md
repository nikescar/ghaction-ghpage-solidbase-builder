...
this project is configurator. it means every component should be run from os itself without any intervention.<br/>
use os components first, and c compiled one, as small as possible to run.
